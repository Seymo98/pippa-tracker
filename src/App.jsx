...
const TRAVEL_PHOTOS = [
  ...
  { id:"angkor-wat-friends-throwback", stopId:29, src:"/travel-photos/angkor-wat-friends-throwback.jpg", date:"2026-06-09", country:"Cambodia", place:"Angkor Wat, Siem Reap", title:"Angkor Wat throwback", caption:"A shared-later Cambodia group shot that also introduces Callie to the travelling cast.", focus:"center" },
  ...
  { id:"koh-phangan-full-moon-arrival", stopId:36, src:"/travel-photos/koh-phangan-full-moon-arrival.jpg", date:"2026-06-24", country:"Thailand", place:"Koh Phangan", title:"Full Moon Party arrival", caption:"Shared later from the Koh Phangan stop: the Full Moon Party chapter begins.", focus:"center" },
  { id:"koh-phangan-full-moon-night", stopId:36, src:"/travel-photos/koh-phangan-full-moon-night.jpg", date:"2026-06-24", country:"Thailand", place:"Koh Phangan", title:"Haad Rin night", caption:"A proper Full Moon Party postcard from Koh Phangan's beach-party night.", focus:"center" },
